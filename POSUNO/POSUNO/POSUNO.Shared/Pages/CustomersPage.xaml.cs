...
namespace POSUNO.Pages
{
    public sealed partial class CustomersPage : Page
    {
        ...
        private async void AddCustomerButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Loader loader = new Loader("Por favor espere");
            loader.Show();
            Response response = await ApiService.PostListAsync("Customers", customer, MainPage.GetInstance().TokenResponse.Token);
            loader.Close();
        ...
        private async void EditImage_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            Loader loader = new Loader("Por favor espere");
            loader.Show();
            Response response = await ApiService.PutListAsync("Customers", customer, customer.Id, MainPage.GetInstance().TokenResponse.Token);
            loader.Close();
        ...
        private async Task<ContentDialogResult> ConfirmDeleteAsync()
        {
            ...
            {
                Title = "Confirmación",
                Content = "Esta seguro de querer borrar el registro?",
