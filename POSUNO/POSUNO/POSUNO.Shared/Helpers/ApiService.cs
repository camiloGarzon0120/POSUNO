...
namespace POSUNO.Helpers
{
    class ApiService
    {
        ...
        public static async Task<Response> PostListAsync<T>(string controller, T model)
        {
            try
            {
                string request = JsonConvert.SerializeObject(model);
        ...
        public static async Task<Response> PutListAsync<T>(string controller, T model, int id)
        {
            try
            {
                string request = JsonConvert.SerializeObject(model);
        ...
        public static async Task<Response> PostListAsync<T>(string controller, T model, string token)
        {
            try
            {
                string request = JsonConvert.SerializeObject(model);
        ...
        public static async Task<Response> PutListAsync<T>(string controller, T model, int id, string token)
        {
            try
            {
                string request = JsonConvert.SerializeObject(model);
